...
namespace EasyMemoryCache.Memcached.Memcached.Results.Extensions
{
    public static class OperationResultExtensions
    {
        ...
        public static IOperationResult Fail(this IOperationResult source, string message, ILogger logger, Exception ex = null)
        {
            if (ex != null)
            {
