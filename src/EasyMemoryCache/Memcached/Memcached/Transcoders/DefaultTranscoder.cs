...
{
    /// <summary>
    /// Default <see cref="T:EasyMemoryCache.Memcached.Memcached.Transcoders.ITranscoder"/> implementation. Primitive types are manually serialized, the rest is serialized using <see cref="T:System.Runtime.Serialization.Formatters.Binary.BinaryFormatter"/>.
    /// </summary>
