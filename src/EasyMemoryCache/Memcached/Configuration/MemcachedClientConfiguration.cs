...
using EasyMemoryCache.Memcached.Memcached.Locators;
...
namespace EasyMemoryCache.Memcached.Configuration
{
    ...
    public class MemcachedClientConfiguration : IMemcachedClientConfiguration
    {
        ...
        /// <summary>
        /// Gets or sets the <see cref="T:EasyMemoryCache.Memcached.Memcached.IMemcachedKeyTransformer"/> which will be used to convert item keys for Memcached.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="T:EasyMemoryCache.Memcached.Memcached.Transcoders.ITranscoder"/> which will be used serialize or deserialize items.
        /// </summary>
